...
public class DBConstants {
	...
	// E2lre : correction bud where a car entry 2 time. get ticket must return the
	// ticket with the last entry
	...
	public static final String GET_COUNT_TICKET = "select count(*) from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? limit 1";
